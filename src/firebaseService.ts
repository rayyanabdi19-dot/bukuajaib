  ...
  if (existingSnap && !existingSnap.exists()) {
    try {
      await setDoc(docRef, {
        ...
        coupleTitle: eventInfo.coupleTitle || 'Buku Tamu Resepsi',
        fullTitle: eventInfo.fullTitle || 'Resepsi Pernikahan',
        groomName: eventInfo.groomName || 'Pengantin Pria',
        brideName: eventInfo.brideName || 'Pengantin Wanita',
        dateStr: eventInfo.dateStr || 'Minggu, 20 September 2026',
        timeStr: eventInfo.timeStr || '10:00 - 21:00 WIB',
        location: eventInfo.location || 'Gedung Resepsi',
        hall: eventInfo.hall || 'Ballroom Utama',
        targetGuests: Number(eventInfo.targetGuests) || 500,
        souvenirStock: Number(eventInfo.souvenirStock) || 500,
        version: eventInfo.version || 'v.1.0.0',
